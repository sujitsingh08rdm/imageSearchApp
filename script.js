let access_key = "LgOfBesFRgB7QbTigBw_nSNIRDRcl8bJId9_gIh9V3M";
...
const getData = async (searchValue, pageNo) => {
  let fetching = await fetch(
    `https://api.unsplash.com/search/photos?query=${searchValue} &perPage=28&P=${pageNo} age&client_id=${access_key}`
  );
